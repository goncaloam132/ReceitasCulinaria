...
<head>
    ...
    <title>Inserir Dados Pessoais</title>
    ...
    <div class="container-fluid fade-up text-top h-custom">
        ...
        <form method="post" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="numero_telefone" class="form-control" required>
            </div>

            <button type="submit" class="btn btn-primary">Inserir Dados Pessoais</button>
        </form>
